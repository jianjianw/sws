...
/**
 * 库存调整报溢–其它入库单	(t_itemother_rk)
 * */
@Entity
@Table(name = "t_itemother_rk", schema = "dbo", catalog = "eabax")
public class TItemotherRk implements Serializable{
    ...
    public boolean equals(Object o) {
        ...
        TItemotherRk that = (TItemotherRk) o;

 ...
 * */
@Entity
@Table(name = "t_itemother_ck", schema = "dbo", catalog = "eabax")
public class TItemotherCk implements Serializable{
    ...
    public boolean equals(Object o) {
        ...
        TItemotherCk that = (TItemotherCk) o;
        ...
        if (strPositionName != null ? !strPositionName.equals(that.strPositionName) : that.strPositionName != null)
            return false;
        if (strinvoicenumber != null ? !strinvoicenumber.equals(that.strinvoicenumber) : that.strinvoicenumber != null)
            return false;
